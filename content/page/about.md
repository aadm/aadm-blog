...
I'm not very "social" these days, but I still have a [Twitter account](http://twitter.com/aadmtwi) that you can use to contact me, and I hang out on the best forum for photonerds on the web, [discuss.pixls.us](https://discuss.pixls.us). I also have a [github account](https://github.com/aadm) where I have mainly [Python code for geophysicists](https://github.com/aadm/geophysical_notes).
